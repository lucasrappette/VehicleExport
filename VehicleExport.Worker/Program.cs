...
using VehicleExport.Worker.BackgroundServices;
using VehicleExport.Worker.Processors;
using Serilog;
...
namespace VehicleExport.Worker
{
    class Program
    {
            ...
            var builder = new HostBuilder()
                .UseSerilog((hostingContext, service, loggerConfig) =>
                {
                    loggerConfig
                        ...
                        .WriteTo.Logger(l => l
                            .MinimumLevel.Debug()
                            .Filter.ByIncludingOnly(Matching.FromSource("VehicleExport"))
                            .WriteTo.Console()
                        )
                        .WriteTo.Logger(l => l
                ...
                .ConfigureAppConfiguration((hostContext, configApp) =>
                {
                    ...
                    List<string> paths = new List<string>()
                    {
                        ...
                        Path.GetFullPath(@"..\..\..\..\VehicleExport.Web\appsettings.json"),
                        Path.GetFullPath($@"..\..\..\..\VehicleExport.Web\appsettings.{environmentName}.json"),
