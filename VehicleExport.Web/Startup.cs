...
using VehicleExport.Web.Filters;
using VehicleExport.Web.Filters.SchemaFilters;
using VehicleExport.Web.Hubs;
using VehicleExport.Web.Middleware;
...
"
                ...
                c.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "VehicleExport.Web.xml"));
                c.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "VehicleExport.Core.xml"));
                c.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "VehicleExport.App.xml"));
            });
